import React__default, { createElement, forwardRef, isValidElement, useRef, useState, useEffect, useCallback, useLayoutEffect, useMemo, useDebugValue, Children, cloneElement, memo, useImperativeHandle, useContext, createContext, Component, Fragment } from 'react';
...
var Portal = /*#__PURE__*/forwardRef(function Portal(props, ref) {
  var children = props.children,
...
var TextareaAutosize = /*#__PURE__*/forwardRef(function TextareaAutosize(props, ref) {
  ...
  return /*#__PURE__*/createElement(Fragment, null, /*#__PURE__*/createElement("textarea", _extends({
    value: value,
...
var InputAdornment$1 = withStyles$1(styles$i, {
...
var InputLabel$1 = withStyles$1(styles$j, {
  name: 'MuiInputLabel'
})(InputLabel);
...
var List$1 = withStyles$1(styles$k, {
  name: 'MuiList'
})(List);
...
var NativeSelectInput = /*#__PURE__*/forwardRef(function NativeSelectInput(props, ref) {
  ...
  return /*#__PURE__*/createElement(Fragment, null, /*#__PURE__*/createElement("select", _extends({
...
var SelectInput = /*#__PURE__*/forwardRef(function SelectInput(props, ref) {
  ...
  return /*#__PURE__*/createElement(Fragment, null, /*#__PURE__*/createElement("div", _extends({
    className: clsx(classes.root, // TODO v5: merge root and select
...
var TextResponse = (props) => TextField$1(Object.assign({className: "field", variant: "outlined"}, props, {label: props.title, onChange: (e)=>props.handleChange(props.id, e.target.value)}));
...
var Visibility$1 = unwrapExports(Visibility);
...
var VisibilityOff$1 = unwrapExports(VisibilityOff);
...
const Password = props => {
    ...
    return TextResponse(Object.assign({}, props,
        ...
        InputProps: {
            endAdornment: InputAdornment$1({position: "end"}, [
                IconButton$1({
                    ...
                    hidden ? Visibility$1() : VisibilityOff$1()
                ])
            ])
        }})
    )
...
const Form = props => {
    ...
    return React__default.createElement('div', {css: getStyle(props)}, [

            props.slides.map((s) => {              // map question slides to that form slide
                // console.log('question slide:', s)
                return React__default.createElement('div', {className: "slide", style: {transform: `translateX(-${100 * slide_idx}%)`}}, [
                    React__default.createElement('div', {className: "form"}, [
                        React__default.createElement('div', {style: {fontSize: '30px', marginBottom: '20px', fontWeight: '900'}}, [
                            s.title,
                            React__default.createElement('div', {className: "detail"}, [
                                s.subtitle
                            ])
                        ]),
                        React__default.createElement('div', {css: css$1`display: flex; flex-direction: column;`}, [
                        ...
                        React__default.createElement('div', {className: "btn-container"}, [
                            Button$1({color: "secondary", size: "large", variant: "contained", className: "submit", text: "Submit", onClick: submit}, [

                                    loading ? CircularProgress$1() :
